...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Rails on Docker starter."
  spec.description = "This Gem provides commands to create a Rails project template for developing Rails projects in Docker."
